  ...
  return (
    <div className="share">
      <Link
        ...
        target="blank_"
      >
        <div className="sh-option rounded bg-blue text-white my-5 shadow px-2 py-2">
          <Image
      ...
      <Link
        ...
        target="blank_"
      >
        <div className="sh-option rounded bg-blue2 text-white my-5 shadow px-2 py-2">
          <Image
      ...
      <Link
        ...
        target="blank_"
      >
        <div className="sh-option rounded bg-green2 text-white my-5 shadow px-2 py-2">
          <Image
